/mob/monkey/Login()
	...
	if (!(src.primarynew))
		src.primarynew = new /obj/dna( null )
		src.primarynew.uni_identity = "00600200A00E01101402301300B009"
		src.primarynew.struc_enzyme = "0983E840344C39F4B059D5145FC5785DC6406A4BB8"
		src.primarynew.use_enzyme = md5(src.name)
